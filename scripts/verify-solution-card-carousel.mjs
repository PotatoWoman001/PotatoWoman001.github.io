...
assert.match(script, /HINT_INTERSECTION_RATIO\s*=\s*0\.25/);
assert.match(script, /HINT_DISTANCE_RATIO\s*=\s*0\.42/);
assert.match(script, /HINT_MAX_DISTANCE\s*=\s*180/);
assert.match(script, /HINT_DELAY\s*=\s*0/);
assert.match(script, /HINT_FORWARD_DURATION\s*=\s*700/);
assert.match(script, /HINT_HOLD_DURATION\s*=\s*500/);
assert.match(script, /HINT_RETURN_DURATION\s*=\s*650/);
