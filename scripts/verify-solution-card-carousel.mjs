...
assert.match(script, /HINT_FORWARD_DURATION\s*=\s*520/);
assert.match(script, /HINT_HOLD_DURATION\s*=\s*260/);
assert.match(script, /HINT_RETURN_DURATION\s*=\s*520/);
