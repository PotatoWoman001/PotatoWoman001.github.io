...
const staticAssetVersion = "20260803-1";
const assetPattern = /(\/assets\/[^"'<>?]+\.(?:js|css))(?:\?v=[^"'<>]+)?/g;
const scriptPattern = /\/assets\/index-DaFvN0XI\.js\?v=20260803-1/g;
const stylePattern = /\/assets\/index-e49ffBFL\.css\?v=20260803-1/g;
